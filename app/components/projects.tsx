...
const projectsData: ProjectInterface[] = [
  {
    title: "Medivac Software System",
    description:
      "This project is a comprehensive platform designed to streamline all aspects of medivac missions, including stock management, personnel coordination, purchase order management, and patient data handling. The client, server, and identity provider are containerized using docker and deployed on AWS EBS.",
    img: [
      "/images/medapp/medapp-photo1.png",
      "/images/medapp/medapp-photo2.png",
      "/images/medapp/medapp-photo3.png",
      "/images/medapp/medapp-photo4.png",
      "/images/medapp/medapp-photo5.png",
      "/images/medapp/medapp-photo6.png",
      "/images/medapp/medapp-databaseSchema.png",
    ],
...

  {
    ...
    description:
      "This system provides a streamlined solution for tracking and managing real items in inventory. It allows the company to monitor the quantity, location, and status of their physical assets, ensuring efficient resource allocation and preventing shortages or overstocking. ",
    img: [
      "/images/operations-manager/opsManager1.png",
      "/images/operations-manager/opsManager2.png",
      "/images/operations-manager/opsManager3.png",
      "/images/operations-manager/opsManager4.png",
      "/images/operations-manager/opsManager5.png",
      "/images/operations-manager/opsManager6.png",
      "/images/operations-manager/opsManager7.png",
      "/images/operations-manager/schema.png",
    ],
  ...
  {
    title: " TSA Catering Website",
    description:
      "Simple landing page for a catering company thats built in nextjs using typescript.",
    img: [
      "/images/catering/tsacatering1.png",
      "/images/catering/tsacatering2.png",
      "/images/catering/tsacatering3.png",
      "/images/catering/tsacatering4.png",
    ],
  ...
  {
    title: "Ts-Identity Provider",
    description:
      "This Node.js code with Express and MySQL acts as an identity provider. It handles user registration, login, and secure access management through JWT tokens, allowing only authorized users to access specific resources. It was build for the Medivac software system, containerized using docker and used to isolate security from the rest of the application",
    img: [],
  ...
  {
    title: "Java Snakes and Ladders Game",
    description: `This project implements a simple Snakes and Ladders game using Java Swing for the GUI. Key classes include: 

- Snakes_and_ladders: Handles game logic, managing player positions, dice rolls, and interactions with snakes and ladders.
- startingpage: Extends Snakes_and_ladders, serves as the initial screen where players enter usernames and start the game.
- gamepage: Manages the main gameplay loop and player interactions.

Players enter their usernames and begin the game, which then progresses through the gamepage interface.`,
    img: [],
    repo: "https://github.com/Omare04/Java-Snakes-And-Ladders-Game",
    stack: [
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="56"

...
const Description = () => {
  return (
    <div className="w-full lg:w-1/2 text-xl md:text-2xl flex flex-col gap-8 md:gap-12 snap-center">
      <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600 mb-2">About Me</h2>
      
      <div className="space-y-4">
        <p>
          Hi, I'm <span className="font-bold text-blue-400">Omar El Masaoudi</span>, a full-stack software engineer with a passion for building 
          <span className="font-semibold"> scalable, cloud-native applications</span>.
        </p>
        ...
        <p>
          ...
          with expertise spanning both front-end and back-end development technologies.
        </p>
      </div>

      <div className="space-y-4">
        <h3 className="text-2xl md:text-3xl font-semibold text-blue-500">Areas of Interest</h3>
        <p className="flex flex-wrap gap-2">
          <span className="px-3 py-1 bg-blue-900/50 rounded-full text-blue-300 text-lg">Machine Learning</span>
          <span className="px-3 py-1 bg-blue-900/50 rounded-full text-blue-300 text-lg">Deep Learning</span>
          <span className="px-3 py-1 bg-blue-900/50 rounded-full text-blue-300 text-lg">Natural Language Processing</span>
          <span className="px-3 py-1 bg-blue-900/50 rounded-full text-blue-300 text-lg">CNNs</span>
          <span className="px-3 py-1 bg-blue-900/50 rounded-full text-blue-300 text-lg">RNNs</span>
          <span className="px-3 py-1 bg-blue-900/50 rounded-full text-blue-300 text-lg">Attention Models</span>
        </p>
      </div>
...
const Skills = () => {
  return (
    <div className="w-full lg:w-1/2 flex flex-col gap-8 pt-6 lg:pt-0 lg:pl-10">
      <div className="space-y-6">
        <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600">Skills</h2>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <SkillCategory 
            title="Languages" 
            skills={["Java", "Go", "Python", "TypeScript", "JavaScript", "Kotlin"]} 
      ...
      <div className="mt-6">
        <h3 className="text-2xl font-semibold text-blue-500 mb-4">Technologies</h3>
        <ProgrammingIcons />
      </div>
    </div>
  );
...
const ProgrammingIcons = () => {
  return (
    <ul className="flex gap-5 flex-wrap pt-2">
      ...
      <TechIcon Icon={IconBrandAmazon} color="#FF9900" name="AWS" />
      ...
      <li className="group">
        ...
        <span className="absolute mt-1 scale-0 rounded bg-gray-800 p-2 text-xs text-white group-hover:scale-100">Java</span>
      </li>
      ...
      <li className="group">
        ...
        <span className="absolute mt-1 scale-0 rounded bg-gray-800 p-2 text-xs text-white group-hover:scale-100">PostgreSQL</span>
      </li>
    </ul>
  );
};
...
const TechIcon: React.FC<TechIconProps> = ({ Icon, color, name }) => {
  ...
  const displayName = name || (Icon.displayName?.replace(/^Icon(Brand)?/, '') || 'Technology');
  ...
  return (
    <li className="group">
      ...
      <span className="absolute mt-1 scale-0 rounded bg-gray-800 p-2 text-xs text-white group-hover:scale-100">{displayName}</span>
    </li>
  );
};
